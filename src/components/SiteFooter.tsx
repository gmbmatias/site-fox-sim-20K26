  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-grid">
        ...
        <div>
          <b>Aprender</b>
          <Link href="/estudos">Trilhas de estudo</Link>
        ...
        <div>
          ...
          <Link href="/meu-progresso">Meu progresso</Link>
        </div>
        <div>
          <b>FOX SIM</b>
      ...
      <div className="shell footer-bottom">
        <span>© {new Date().getFullYear()} FOX SIM.</span>
        <span>Feito para quem estuda o céu.</span>
      </div>
    </footer>
  );
}
